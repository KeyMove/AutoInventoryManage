...
namespace com.github.KeyMove.Tools
{
    ...
    public class UserInfo
    {
        ...
        public void SendString(string str)
        {
            ...
            handle.Send(data, data.Length, Target);
        }

        public void RecvData(Action<UserInfo,byte[]> callback)
        {
            ...
            if (RecvDataCallBack != null)
            {
                new Task(() => {
                    while (RecvDataCallBack != null)
                    {
                        ...
                        byte[] data=handle.Receive(ref ep);
                        if (RecvDataCallBack == null) return;
                        try
                        {
                            RecvDataCallBack(this, data);
                        }
                        catch { }
                    }
                }).Start();
    ...
    public class ESPUDP
    {
        ...
        Dictionary<int, Action<UserInfo, MemoryStream>> ActionMap = new Dictionary<int, Action<UserInfo, MemoryStream>>();
        ...
        public void OnRecvData(int id, Action<UserInfo, MemoryStream> act)
        {
